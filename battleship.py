# код для данной самостоятельной работы я написал, ориентируясь на вебинар разбора проекта,
#     так как сам не до конца овладел всеми навыками, данными в модуле C, чтобы успеть
#                      выполнить данную работу в сроки дедлайнa
